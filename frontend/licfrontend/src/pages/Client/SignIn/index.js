...
import Background from '../../../images/lic.png'
...
const Signin = () => {
      ...
      axios.post(url, data).then((Response) => {
        ...
        if (!result) {
          ...
          if (result["role"] == "client") {
            ...
            alert("Enter valid client details")
          }
        }
      })
    }
  ...
  return (
    <div>
      ...
      <div style={{ backgroundImage: `url(${Background})`, width: "100%", height: "600px", backgroundRepeat: "no-repeat" }}>
        <div className="row" style={{ paddingLeft: 1000, paddingTop: 20 }}>
          <div className = "float-end">
          <div class="card" id= "card1">
          <h1 className="title" style={{ color: 'darkblue' }}><b><u>Signin</u></b></h1>
            ...
            <div className="form" style = {{width : "156%", marginLeft:20}}>
              ...
              <div className="mb-3" style={{ paddingTop: 10 }}>
                ...
                <div style={{ marginTop: 20, textAlign: "center", fontSize: 18 }}>
                  <a href="/resetpassword" ><b>Reset Your Password</b></a>
                </div>
                <hr></hr>
                <div style={{ paddingTop: 20, textAlign: "center" }}>
                  ...
                  <br></br>
                  <Link to="/user/signup">
                    <button className="btn btn-success"><b>Signup here <IoCreateOutline/></b></button>
